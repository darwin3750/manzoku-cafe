...
<div class="container manzoku-border-base-3 contact-card rounded p-3">
  <form id="contact-form row d-flex mt-5 mx-auto" method="POST" action="components/scripts/modify-contact-messages.script.php" role="form">
    <div class="row">
      <div class="col-sm-3">
        <div class="form-group manzoku-color-contrast">
          <label for="name" class="manzoku-bold">Name <span class="manzoku-color-accent1">*</span></label>
      ...
      <div class="col-sm-3">
        <div class="form-group manzoku-color-contrast">
          <label for="email" class="manzoku-bold">Email <span class="manzoku-color-accent1">*</span></label>
      ...
      <div class="col-sm-3">
        <div class="form-group manzoku-color-contrast">
          <label for="phone" class="manzoku-bold">Phone</label>
          <input id="phone" type="tel" name="phone" class="manzoku-form-transparent" placeholder="09123456789">
        </div>
      </div>
      <div class="col-sm-3">
        <div class="form-group manzoku-color-contrast">
          <label for="subject" class="manzoku-bold">Subject <span class="manzoku-color-accent1">*</span></label>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group manzoku-color-contrast">
          <label for="message">Message <span class="manzoku-color-accent1">*</span></label>
