<section class="p-1">
  ...
  <div class="container manzoku-border-base-3 contact-card rounded p-3 pb-0">
    <form id="contact-form row d-flex mt-5 mx-auto" method="POST" action="components/scripts/modify-contact-messages.script.php" role="form">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <input type="submit" class="btn manzoku-btn-accent1 btn-lg btn-block manzoku-typeface-main0" name="send-message">
        </div>
      </div>
      <div class="row">
